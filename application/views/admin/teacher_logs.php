		...
		<div class="row white-text">
			...
			<div class="col s12">
				<table class="highlight">
					...
					<tbody>
						<?php foreach($a_teacher_logs as $teacher){?>
							<tr>
								<td class="id"><?= $teacher->id ?></td>
								<td class="first"><?= $teacher->first_name?></td>
								<td class="last"><?= $teacher->last_name ?></td>
								<td class="department"><?= $teacher->department ?></td>
	...
	<div class="row">
		...
		<div class="input-field col s8">
      	...
      	<div class="col s8 offset-s2 center-align">
			<a class="waves-effect waves-light btn-large transparent-border white-text">Add Teacher</a>
		</div>
	</div>
</div>